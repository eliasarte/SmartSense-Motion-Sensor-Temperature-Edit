...
metadata {
	definition(name: "MotionTempEdit", namespace: "smartthings", author: "SmartThings", runLocally: true, minHubCoreVersion: '000.017.0012', executeCommandsLocally: true,
				mnmn: "SmartThingsCommunity", vid: "d04e2a44-7b06-3fe8-8183-98308c508fec", ocfDeviceType: "oic.d.thermostat", //add these to change type to thermostat and load new presentation
				genericHandler: "Zigbee") {
